...
jQuery(document).ready(function($) {
        ...
        if ($(window).width() > MQL) {
            ...
            $(window).on('scroll', {previousTop: 0},function header() {
      var headerHeight = $('.navbar-custom').height();
        ...
        if (currentTop < this.previousTop) {
            ...
            if (currentTop > 0 && $('.navbar-custom').hasClass('is-fixed')) {
                if ($('.navbar-custom').hasClass('has-admin-bar'))
                {
                    $('.navbar-custom').addClass('is-visible  plus-bar');
                    $('.input-search').addClass('is-visible');
                }
                else
                    $('.navbar-custom').addClass('is-visible');
            } else {
                $('.navbar-custom').removeClass('is-visible is-fixed plus-bar');
                $('.input-search').removeClass('is-visible');
            }
        } else {
            //if scrolling down...
            $('.navbar-custom').removeClass('is-visible plus-bar');
            if (currentTop > headerHeight && !$('.navbar-custom').hasClass('is-fixed')) $('.navbar-custom').addClass('is-fixed');

            if ($('.navbar-custom').hasClass('has-admin-bar'))
                $('.navbar-custom').addClass('plus-bar');
        }
...
function header(){
  if ($('html').hasClass('front-page-home') == false) {
            $('.navbar-custom').addClass('is-visible is-fixed plus-bar');
            return;
        }
}
